    ...
    >
     <div class="card">
      ...
      <!-- FORM --> 
          ...
          <tr>
              <td class='text-uppercase text-sm'>nama_menu_</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input
                    type="text"
                    placeholder="nama_menu_"
                    id="nama_menu"
                    name="nama_menu"
                    class="form-control form-control-sm"
      ...
      <!-- SUBMIT -->
    </form><div class="text-center" v-if="aksi!='insert'">
  <br>
...
export default {
  ...
  methods: {
    insert(){
          ...
          let that = this
          this.vdata.kategori = this.$route.query.data
          db.collection(`menu_kategori`).doc().set(this.vdata).then(res=>{
        ...
        let that = this
          if(confirm('Apakah yakin menghapus data?')){
              db.collection(`menu_kategori`).doc(this.vdata.id).delete().then(res=>{
       ...
       refreshData() {
         let that = this
         db.collection(`menu_kategori`).doc().get('*',`where tb1.kategori='${this.$route.query.data}'`).then(res=>{
          setTimeout(() => {
            (function() {
              var thElm;
              var startOffset;

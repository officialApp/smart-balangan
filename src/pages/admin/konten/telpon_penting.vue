    ...
    >
     <div class="card">
        <div class="card-header">  <button type="button" @click="$router.push('/admin')" class="btn btn-sm btn-dark  mr-4"><img src="https://upload.egov.balangankab.go.id/svg/arrow-left.svg" 
               class="d-inline" style="height:20px;width:20px;filter: brightness(0) invert(1);" alt=""> Back</button> LIST Telpon Penting</div>
        <div class="card-body">
      <!-- FORM --> 
          <tr>
          ...
          <tr>
              <td class='text-uppercase text-sm'>no telpon</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
                <div class="sm-form">
                  <input

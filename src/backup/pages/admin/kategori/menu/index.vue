<template>
  <div class="font-times">
    ...
    >
     <div class="card">
        <div class="card-header">menu_kategori</div>
        <div class="card-body">
      <!-- FORM --> 
          <tr>
          ...
          <tr>
              <td class='text-uppercase text-sm'>kategori_</td>
              <td>&nbsp;:&nbsp;</td>
              <td style="width:90%;padding-bottom:5px;">
...
export default {
  ...
  methods: {
    insert(){
       ...
       refreshData() {
         let that = this
         db.collection(`menu_kategori`).doc().get('*','').then(res=>{
          setTimeout(() => {
            (function() {
              var thElm;
              var startOffset;
